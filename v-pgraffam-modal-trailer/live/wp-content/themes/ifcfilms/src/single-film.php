  ...
  <div class="inner-wrap">
    ...
    <?php if (have_posts()): while (have_posts()) : the_post(); ?>
      ...
      <section class="single-page color-<?php the_field('color'); ?>">
        <div class="header-container row">
          ...
          <div class="single-top-bg">
            <div class="small-12 text-center">
              ...
              <div class="single-trailer trailer-color button button-fill" data-video-id="<?php the_field('bc_trailer_id'); ?>" data-title="<?php the_title(); ?>"><?php get_template_part('partials/svgs/video', 'play') ?> Trailer</div>
            </div>
        ...
        <!-- start row desktop wrapper - hidden from mobile -->
        <div class="full-row single-row desktop">
          <div class="columns large-9 column-divider"> <!-- this column is for main content -->
          <!-- go watch it -->
          <?php if(get_field('gowatchit_id')) : ?>
            <div class="small-12">
              <div class="row watch-now">
          ...
          <!-- sidebar - hide if mobile-->
          <div class="columns large-3 mobileSidebar"> <!-- 06-02 this columns is for sidbar -->
            <div class="sidebar">
          ...
          <!-- sidebar - hide if mobile-->
          <div class="columns large-3 desktopSidebar"> <!-- 06-02 this columns is for sidbar -->
          <div class="sidebar">
            <div class="cast single-row small-collapse row"> <!-- 06-02 removed bottom border class -->
              <?php
              $film_credits = array(
          ...
          <!-- end row desktop wrapper - hidden from mobile -->
                  ...
                  <?php foreach ($films as $film) : ?>
                    <li>
                      <a href="<?php echo get_permalink($film->ID); ?>">
                        <img src="<?php the_field('film_thumb', $film->ID); ?>" alt="<?php echo $film->post_title; ?>" />
