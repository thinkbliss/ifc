            ...
            <li>
              ...
              <section class="trailer-info color-1">
                ...
                <ul class="small-block-grid-3">
                  <?php if($item->bc_trailer_id) : ?><li><a class="single-trailer button" data-video-id="<?php $item->bc_trailer_id; ?>" data-title="<?php $item->post_title; ?>" href="#"><?php get_template_part('partials/svgs/video', 'play') ?> Trailer</a></li><?php endif; ?>
                  <li><a class="button" href="<?php echo get_the_permalink($item->ID); ?>">See More</a></li>
                  <?php if($item->gowatchit_id) : ?><li><a class="watch button gwi-widget" data-id="<?php echo $item->gowatchit_id; ?>" data-type="movie" data-render="button" data-flavor="availability" data-layout="tabs" data-categories="3" data-tv-selectors="true">Watch Now</a></li><?php endif; ?>
                </ul>
              </section>
            </li>
