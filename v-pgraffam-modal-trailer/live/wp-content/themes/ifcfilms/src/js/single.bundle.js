...
$('.single-trailer').on('click', function(e) {
  e.preventDefault();
...
$document.on('click', '.close-modal', function(e) {
  ...
  setTimeout(function() {
    ...
    // recreate foundation close modal so that display doesn't get set to none and cause player issues
    $('#trailerModal, #videoModal').velocity({opacity: 0}, {duration: config.animationTiming, easing: config.easing, complete: function() {
...
$document.on('opened', '[data-reveal]', function () {
  ...
  if(typeof(modal.data('revealInit').data) !== 'undefined') {
    ...
    if (modal.context.id == "videoModal") {
      videoPlayerStart(loadingSpinner, videoId, "main");
    } else if (modal.context.id == "trailerModal") {
      videoPlayerStart(loadingSpinner, videoId, "trailer");
    }
  }
});
...
},{"./../modules/globals/config":8,"./../modules/globals/universal":10,"./../modules/globals/velocity-animations":11,"./../modules/header-scroll":12,"./../modules/hide-load-video":13,"./../modules/quote-rotator":14,"./../modules/search":15,"./../modules/single-accordion":18,"./../modules/single-gallery":19,"./../modules/social-facebook":20,"./../modules/social-twitter":21,"./../modules/trailer-drawer-close":22,"./../modules/trailer-drawer-open":23,"./../modules/trailer-drawer-rotation":24,"./../modules/video-events":25,"./../modules/video-player-start":28,"foundation":2,"jquery":3,"nprogress":4}],2:[function(require,module,exports){
(function (global){
...
; browserify_shim__define__module__export__(typeof NProgress != "undefined" ? NProgress : window.NProgress);
...
; browserify_shim__define__module__export__(typeof rangeslider != "undefined" ? rangeslider : window.rangeslider);
...
},{"./trailers-json":9,"jquery":3}],9:[function(require,module,exports){
module.exports =
  [
    {
...
},{"velocity":6,"velocity-ui":7}],12:[function(require,module,exports){
...
},{"./globals/config":8,"./search":15}],13:[function(require,module,exports){
var NProgress = require('nprogress');
var velocity = require('velocity');
...
},{"./globals/config":8,"./set-trailer-drawer-info":16,"./set-trailer-drawer-top-nav":17,"./video-load":27,"nprogress":4,"velocity":6}],14:[function(require,module,exports){
    var $ = require('jquery');
    var config = require('./globals/config');
...
},{"./globals/config":8,"jquery":3}],15:[function(require,module,exports){
...
},{"./globals/config":8,"jquery":3}],16:[function(require,module,exports){
var velocity = require('velocity');
...
module.exports = function(trailerDrawerBG, trailerDrawerTitle, trailerDrawerInfoTitle, trailerDrawerDesktop) {
  ...
  trailerDrawerTitle.text(currentTrailer.post_title).velocity({ opacity: 1 }, { duration: 300 });

  // set drawer title inside drawer info
  trailerDrawerInfoTitle.text(currentTrailer.post_title);

  // set video id to data
  trailerDrawerDesktop.data('video-id', currentTrailer.bc_trailer_id);
};

},{"./globals/config":8,"velocity":6}],17:[function(require,module,exports){
var config = require('./globals/config');
...
},{"./globals/config":8}],18:[function(require,module,exports){
...
},{"./globals/config":8,"velocity":6}],19:[function(require,module,exports){
...
},{"./globals/config":8,"velocity":6}],20:[function(require,module,exports){
...
},{"./globals/config":8,"./trailer-drawer-rotation":24,"./video-events":25,"velocity":6}],23:[function(require,module,exports){
var $ = require('jquery');
var velocity = require('velocity');
...
},{"./globals/config":8,"./video-player-start":28,"jquery":3,"rangeslider":5,"velocity":6}],24:[function(require,module,exports){
var $ = require('jquery');
var NProgress = require('nprogress');
var velocity = require('velocity');
...
},{"./globals/config":8,"./set-trailer-drawer-info":16,"./set-trailer-drawer-top-nav":17,"jquery":3,"nprogress":4,"velocity":6}],25:[function(require,module,exports){
var $ = require('jquery');
...
},{"./globals/config":8,"jquery":3}],26:[function(require,module,exports){
var $ = require('jquery');
...
},{"./globals/config":8,"jquery":3}],27:[function(require,module,exports){
var $ = require('jquery');
var NProgress = require('nprogress');
...
},{"./globals/config":8,"jquery":3,"nprogress":4}],28:[function(require,module,exports){
var $ = require('jquery');
...
},{"./globals/config":8,"./video-events":25,"./video-interact":26,"./video-load":27,"jquery":3}]},{},[1]);
