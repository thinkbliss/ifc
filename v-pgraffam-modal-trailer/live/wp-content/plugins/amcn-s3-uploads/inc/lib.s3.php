...
*/
class AMCN_S3_Uploads_Crypt_HMAC {
var $_func;var $_ipad;var $_opad;var $_pack;
function AMCN_S3_Uploads_Crypt_HMAC($key, $func = 'md5'){$this->setFunction($func);$this->setKey($key);}
...
*/
if (!class_exists('AMCN_S3_Uploads_Curl')) require_once (dirname(__FILE__).'/../inc/curl.php');
...
class AMCN_S3 {
	 ...
	 *
	*/
	function AMCN_S3($accessKeyId, $secretKey, $serviceUrl="http://s3.amazonaws.com/") {
		global $wpdb;
		$this->serviceUrl=$serviceUrl;
		$this->accessKeyId=$accessKeyId;
		$this->secretKey=$secretKey;
		$this->req =& new AMCN_S3_Uploads_Curl($this->serviceUrl);
		$this->options = array();
		$this->options['cache_table'] = $wpdb->prefix . 'amcn_s3_uploads_cache';
    ...
    */
	...
	function constructSig($str) {
		$hasher =& new AMCN_S3_Uploads_Crypt_HMAC($this->secretKey, "sha1");
